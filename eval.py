...
if __name__ == "__main__":
    ...
    if os.path.isfile('%s/full_info.log'%os.path.dirname(options.inputModel)):
        ...
        val_accuracy = np.asarray(myDictOfLists[b'val_accuracy'])

        accuracy = np.asarray(myDictOfLists[b'accuracy'])
...
#python eval.py -t t_allpar_new \ -i ../data/processed-pythia82-lhc13-all-pt1-50k-r1_h022_e0175_t220_nonu_withPars_truth.z \ -m train_simple/KERAS_check_best_model.h5 \ -c train_config_conv1d.yml \ -o train_simple_l10p0001/
